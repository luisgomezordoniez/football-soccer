...
We want to examine how football has evolved over the years in terms of attack and defense. We hypothesize that English football has become more competitive. To prove this hypothesis, we will analyze the differences among the teams that comprise the Premier League and the lower tiers, including their dominance and match results.

First of all, we recognize that goals can be a strong indicator of this understanding, so we base our initial analysis on the average number of goals scored by teams.
...
While the average number of goals scored by home teams has remained relatively stable since 1993, away teams have shown a clear upward trend in goals, reflecting more offensive strategies, especially since 2015. This suggests a reduction in the traditional home-field advantage.

Between 1993 and 2010, away teams scored approximately 1.10-1.15 goals per match; however, since 2011, this number has increased to around 1.20-1.25. Starting in 2018, we can observe a sustained rise in away goals, reaching historic highs in 2023 and 2024, when they exceeded 1.45 goals per match.

Home teams have consistently scored between 1.45 and 1.65 goals per match throughout the entire period, with small drops in 2008 and 2015. In 2023, there was an increase, although not one strong enough to confirm an upward trend.

Home-field advantage has decreased significantly over the years. The recent surge in offensive performances in the Premier League comes mainly from away teams.
...
Football is a low-scoring sport. The most frequent results are 0-0, 1-0, and 1-1.
:::
...
The Premier League is considered an extremely competitive league due to its more equitable distribution of broadcasting revenue, the quality of signings, and the high athletic level of the players. Nevertheless, if we look at last Season´s table, we can identify three types of teams: those that fight for the top positions, those that remain in the middle of the table, and those that struggle to avoid finishing last. The first ten matches of the 2024/2025 season were not enough to predict how the teams would finish; after the tenth match, the die was pretty much cast, and the battle unfolded within each of these three groups.

::: {.callout-note collapse="true"}

## Champions

The champion of a season is the team with the most points. A victory grants 3 points, a draw grants 1 point, and a loss grants 0 points. Liverpool and Manchester City are the two teams with the most titles in the top tier, with 20 titles. Liverpool experienced a drought from the 1989/1990 season to the 2019/2020 season.
:::
...
This bar chart displays the total number of Premier League seasons (1995-2025) for each team, with yellow segments indicating titles won and colors distinguishing between current Premier League teams (darker blue) and those in lower tiers (lighter blue). In our sample, Man United leads with 12 titles across 30 seasons, followed by Man City (8), Chelsea (5), Arsenal (3), and Liverpool (2), while Leicester and Blackburn each won once. The "Big Six" (Tottenham, Manchester United, Liverpool, Everton, Chelsea, Arsenal) have maintained a near-constant presence in the Premier League. At the same time, many clubs, such as Leeds, Nottingham Forest, and Sheffield United, have spent significant periods in lower divisions, illustrating the difficulty of sustaining top-flight status outside the elite group.
...
```
When we analyze the teams in the current Season and compare their historical positions, we can confirm the behavior observed in the previous plot. We also see that all the teams ranked from tenth place downward were not competing in the Premier League twenty-five years ago. Most of them had already been in the league for five years. However, some, such as Bournemouth, Brentford, Nottingham Forest, and Luton, were not consistently present before and have only recently been promoted to the Premier League.

This is a positive sign for the league's competitiveness, as it indicates that newly promoted teams can enter the Premier League and compete with the top clubs.
...
```
Here, we display the locations of football stadiums for all clubs across the top four tiers of English football. The highlighted labels identify only the teams competing in the most recent Premier League season. The regions are shaded according to the number of clubs (tiers 1–4) they contain, revealing clear geographic patterns: the North West emerges as the strongest football hub, with the highest concentration of clubs and multiple Premier League sides, including Manchester United, Manchester City, Liverpool, and Everton. Greater London also features a dense cluster of stadiums and several Premier League teams, including Arsenal, Chelsea, Tottenham, West Ham, Crystal Palace, Fulham, and Brentford, reflecting the capital’s deep football heritage. Regions like Yorkshire and the Humber, the Midlands, and the South Coast host fewer top-flight teams but remain important centers of the broader football pyramid. In contrast, areas such as the South West and East Wales contain very few professional clubs. Overall, the map illustrates both the widespread presence of football across England and the regional clustering of elite Premier League teams in major urban and historically industrial areas.
...
## Teams
We have 116 different teams in our sample!
:::
...
ggplot(teams_timeline, aes(x = substr(Season,6,9), y = Tier, group = Team)) +
  ...
  scale_x_discrete(breaks = c("1995", "2000", "2005","2010","2015", "2020","2025"))+
...
This visualization tracks the league-tier journeys of the only clubs that have appeared in all four tiers of the English football pyramid between 1993 and 2024. Each panel represents a single club, showing how its competitive level has shifted over three decades. Overall, the chart highlights the unusual and turbulent nature of a club competing in all four tiers, visually emphasizing the instability, promotions, relegations, and competitive volatility these clubs have experienced. 
...
Across teams, we observe strong positive associations between shots on target and goals scored, as well as between shots on target conceded and goals conceded. However, shots on target generated by a team show no meaningful relationship with the goals it concedes, suggesting that offensive productivity and defensive vulnerability operate independently of each other.

## Detection of clusters

We know that many of the numerical variables in our dataset are related, so within each league, we aim to identify clusters of teams that exhibit similar behavior across seasons. Based on these clusters, we can create indices and provide explanations for the observed patterns.
...
```
We performed a PCA analysis using some of the numerical variables that we have in our dataset. The biplot reveals a distinct contrast between top-attacking teams and lower-performing or defensively burdened teams, with a secondary axis highlighting discipline versus cleanliness in play style. Traditionally, the English sports press has clustered Manchester United, Manchester City, Liverpool, Arsenal, Chelsea, and Tottenham as the top six important teams (The Big 6); however, here we can see that Tottenham is not as close to the rest of the Big 6 teams. At the same time, Liverpool possesses great attacking power and a low rate of average fouls committed.
...
```
This graph displays the monthly proportion of wins, draws, and losses for England's Big 6 teams from 1995 to 2025, revealing a clear performance hierarchy. Man City and Liverpool dominate with consistently high win rates (50-65%). In comparison, Man United shows periods of exceptional performance with win rates approaching 70%, likely reflecting their success in the earlier years of this period. Arsenal and Chelsea maintain a steady mid-tier performance, with win rates of around 50-60%. Tottenham shows the most concerning trend, with their win rate (blue) declining and loss rate (green) increasing significantly, particularly toward the end of the Season, where losses nearly match wins by May. Draw rates remain relatively stable across all teams, ranging from 20% to 30%. However, there is some month-to-month variation; no dramatic seasonal patterns emerge, suggesting that these proportions reflect overall team quality rather than specific calendar effects.

## Referee analysis, is there bias?
...
Referees |>
  ...
  geom_point(size = 3, color = "#191970", aes(shape=as.character(n_tiers))) +
  coord_flip() +
  labs(
    title = "Top Referees by Match Count",
    x = "Referee",
    y = "Matches",
    shape="Number of tiers"
  ) +
  theme_football()+
  theme(legend.position="bottom")

```
This graph ranks the top Premier League referees by the total number of matches officiated between 1995 and 2025, with Mike Dean leading with approximately 650 matches, followed by Kevin Friend and Martin Atkinson, who have officiated around 600 matches each. The symbols distinguish referees who worked through 3 tiers (circles) versus four tiers (triangles) of English football before reaching the Premier League, showing a relatively even mix of both pathways among the most experienced officials. Most top referees cluster between 400 and 650 matches, representing typical career lengths at the Premier League level over these 30 years, with no clear correlation between the number of lower divisions worked and ultimate longevity in the top flight.
...
Referees |>
  ...
  ggplot(aes(x = Count_matches, y = home_win_rate,color=as.character(n_tiers))) +
...
The data shows a clear downward trend: less experienced referees (under 100 matches) display more scattered and often higher home win rates (ranging from 0.3 to 0.7), while more experienced referees (300+ matches) cluster around a narrower, lower range of approximately 0.35-0.45. This pattern suggests that experienced referees indeed show reduced home bias, with their decisions converging toward more consistent outcomes, regardless of the venue. The color coding reveals no evident pattern between the number of tiers worked and home bias, indicating that total experience rather than career pathway is the key factor in minimizing home advantage effects.
```{r}
...
ggplot(significant_ref_team, aes(x = Referee, y = HomeTeam)) +
  ...
  labs(
    ...
    x = "Referee",
    y = "Home Team",
    caption = "Only included home team-referee combiantions with at least 25 games"
  ) + theme_football()+
  theme(
    axis.text.x = element_text(angle = 45, hjust = 1, size = 8),
...
This heatmap displays home team win rates for specific referee-team combinations (with a minimum of 25 matches), where red indicates higher win rates and blue indicates lower rates. Arsenal displays consistently high home win rates across all referees, while Man City performs exceptionally well under M Oliver. Top teams like Arsenal, Man City, and Liverpool generally show stronger home performance (more red) across most referees, likely reflecting their overall quality rather than referee bias. In contrast, teams like Tottenham, Everton, and Rochdale show more blue shading, indicating lower home win rates that suggest either weaker home form or more neutral officiating during these matches.
...
ggplot(significant_ref_team_away, aes(x = Referee, y = AwayTeam)) +
  geom_tile(aes(fill = Home_win_rate), color = "white") +
  scale_fill_gradient2(
    low = "#191970", mid = "white", high = "darkred", 
    midpoint = 0.5,  # Average home win rate
  ...
  labs(
    ...
    x = "Referee",
    y = "Away Team",
    caption = "Only included away team-referee combiantions with at least 25 games"
  ) + theme_football()+
  theme(
    axis.text.x = element_text(angle = 45, hjust = 1, size = 8),
    axis.text.y = element_text(size = 7),
...
```
The predominantly blue coloring reflects the inherent difficulty of winning away matches in football, with most combinations showing low away win rates. Chelsea stands out with notably higher away success under M Halsey (red shading), while Sunderland shows relatively stronger away performance under P Dowd. The overall pattern confirms that away wins remain rare across most referee-team combinations, with only occasional red cells indicating exceptions where top teams managed to overcome the typical away disadvantage.
## Fair play
...
From 2000 to 2024, fouls per match show an overall decreasing trend, especially from 2000 to 2013, followed by a more stable pattern in recent years. This behavior can be attributed to improved playing techniques and stricter enforcement of strategies by referees. When examining yellow cards over the same period, we observe a consistent increasing trend, more pronounced in the last years. This suggests that, even though fouls decreased, referees continued issuing yellow cards at similar rates, which is evidence of a stricter interpretation of the rules. This aligns with the fact that the regulations have become stronger and penalize more unsporting conduct. Red cards, meanwhile, have historically been rare events in matches. Although they appear to decrease slightly, they remain at consistently low levels.

::: {.callout-note collapse="true"}

## Cards

A yellow card is a formal caution for minor misconduct, such as dissent, time-wasting, or unsporting behavior. In contrast, a red card results in a player's dismissal from the game for serious offenses (e.g., violent conduct, denying a goalscoring opportunity) or receiving a second yellow card in the exact match, forcing the player's team to play with one fewer player. 
:::
