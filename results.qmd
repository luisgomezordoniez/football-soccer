...
The champion of a season is the team with most points. A victory grants 3 points, a draw grants 1 point and a loss grants 0 points. Liverpool and Manchester City are the two teams with most titles in the top tier with 20 titles. Liverpool had a drougth from the season 1989/1990 to the season 2019/2020.
:::
...
This bar chart shows total Premier League seasons (1995-2025) for each team, with yellow segments indicating titles won and colors distinguishing current Premier League teams (darker blue) from those in lower tiers (lighter blue). In our sample, Man United leads with 12 titles across 30 seasons, followed by Man City (8), Chelsea (5), Arsenal (3), and Liverpool (2), while Leicester and Blackburn each won once. The "Big Six" (Tottenham, Man United, Liverpool, Everton, Chelsea, Arsenal) have maintained near-constant Premier League presence, while many clubs like Leeds, Nottingham Forest, and Sheffield United have spent significant periods in lower divisions, illustrating the difficulty of sustaining top-flight status outside the elite group.
...
Each season the bottom 3 teams are relegated to the Championship (second tier), while 3 teams of the Championship are promoted to the Premier League, the two top-finishing teams are automatically promoted to the Premier League. The teams that finish the season in third to sixth place enter a play-off tournament, with the winner also gaining promotion to the Premier League.
:::
...
```
This graph displays the monthly proportion of wins, draws, and losses for England's Big 6 teams from 1995 to 2025, revealing a clear performance hierarchy. Man City and Liverpool dominate with consistently high win rates (50-65%), while Man United shows periods of exceptional performance with win rates approaching 70%, likely reflecting their success in the earlier years of this period. Arsenal and Chelsea maintain steady mid-tier performance with win rates around 50-60%. Tottenham shows the most concerning trend, with their win rate (blue) declining and loss rate (green) increasing significantly, particularly toward the end of the season where losses nearly match wins by May. Draw rates remain relatively stable across all teams at 20-30%, and while there's some month-to-month variation, no dramatic seasonal patterns emerge, suggesting these proportions reflect overall team quality rather than specific calendar effects.
...
```
This graph ranks the top Premier League referees by total matches officiated between 1995 and 2025, with Mike Dean leading at approximately 650 matches, followed by Kevin Stroud and Martin Atkinson around 600 matches. The symbols distinguish referees who worked through 3 tiers (circles) versus 4 tiers (triangles) of English football before reaching the Premier League, showing a fairly even mix of both pathways among the most experienced officials. Most top referees cluster between 400-650 matches, representing typical career lengths at the Premier League level over this 30-year period, with no clear correlation between the number of lower divisions worked and ultimate longevity in the top flight.
...
This heatmap shows home team win rates for specific referee-team combinations (minimum 25 matches), with red indicating higher win rates and blue indicating lower rates. Arsenal displays consistently high home win rates across all referees, while Man City performs particularly well under M Oliver. Top teams like Arsenal, Man City, and Liverpool generally show stronger home performance (more red) across most referees, likely reflecting their overall quality rather than referee bias, while teams like Tottenham, Everton, and Rochdale show more blue shading, indicating lower home win rates that suggest either weaker home form or more neutral officiating during these matches.
...
A yellow card is a formal caution for minor misconduct like dissent, time-wasting, or unsporting behavior, while a red card is a dismissal from the game for serious offenses (e.g., violent conduct, denying a goal-scoring opportunity) or receiving a second yellow card in the same match, forcing the player's team to play with one less player. 
:::
